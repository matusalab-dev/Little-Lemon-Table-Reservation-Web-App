    ...
    <>
      ...
      >
        ...
        <ul className="max-w-1/2 text-md  flex items-center justify-between font-secondary font-semibold capitalize">
          ...
          <NavHashList title="About" href="#about" className="flex lg:hidden" />
          ...
          <NavLinkList
            ...
            className="flex lg:hidden"
          />
          <NavLinkList title="Log In" to="/log-in" className="flex lg:hidden" />
      ...
      <nav role="navigation" aria-label="Mobile Navigation" aria-hidden="true">
        ...
        >
          ...
          <NavHashList title="About" href="#about" className="flex " />
          <NavHashList title="Menu" href="#menu" className="flex " />
